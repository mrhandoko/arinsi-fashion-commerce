          ...
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 150px;">
                    <input type="text" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" class="form-control quaility" />
              ...
              <tr>
                ...
                <td class="text-left"><div class="input-group btn-block" style="max-width: 150px;">
                    <input type="text" name="" value="1" size="1" disabled="disabled" class="form-control quaility" />
